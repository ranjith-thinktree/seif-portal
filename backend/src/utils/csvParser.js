...
const validateRow = (row, rowNumber, availableCourses = []) => {
  ...
  if (!data['Batch End Date']?.trim()) {
    errors.push(cellError(rowNumber, 'Batch End Date', 'value is required'));
  } else if (!isValidDate(data['Batch End Date'])) {
  ...
  if (!data['Gender']?.trim()) {
    ...
    !ALLOWED_VALUES.gender.map((g) => g.toLowerCase()).includes(data['Gender'].trim().toLowerCase())
  ) {
    errors.push(
  ...
  if (!data['Qualification']?.trim()) {
    errors.push(cellError(rowNumber, 'Qualification', 'value is required'));
  }

  // Address fields (required)
  if (!data['Student Address']?.trim()) {
    errors.push(cellError(rowNumber, 'Student Address', 'value is required'));
  }

  if (!data['Student City']?.trim()) {
    errors.push(cellError(rowNumber, 'Student City', 'value is required'));
  }

  if (!data['Student District']?.trim()) {
    errors.push(cellError(rowNumber, 'Student District', 'value is required'));
  }

  if (!data['Student State']?.trim()) {
    errors.push(cellError(rowNumber, 'Student State', 'value is required'));
  }
