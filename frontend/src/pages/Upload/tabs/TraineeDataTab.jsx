        ...
        {noteOpen && (
          <div className="bg-amber-50 px-4 pb-4 pt-1 border-t border-amber-200">
            <p className="text-amber-700 text-sm">
              You can only upload data for <strong>approved centers</strong>. If
              you try to upload data for centers that are pending approval, the
              upload will be rejected. Please ensure all centers in your CSV
