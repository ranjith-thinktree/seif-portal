...
// Note: partner_student_id is auto-generated during upload processing
...
const EXPECTED_EMPLOYMENT_COLUMNS = [
  'Center ID',
  'Student ID', // partner_student_id (auto-generated, pre-filled from DB)
  'Batch ID',
  'Student Name',
  'Father Name',
  'Employment Status',
    ...
    worksheet.getColumn(2).eachCell({ includeEmpty: false }, (cell, rowNumber) => {
      if (rowNumber > 1) {
        cell.dataValidation = {
          ...
          allowBlank: false,
          formulae: [
            '"Employed,Self-Employed,Entrepreneur,Unemployed,Further Education,Higher Study,NA"',
          ],
...
const generateDynamicTemplate = async (
  ...
  try {
    ...
    // Define columns with styling (Student ID removed - auto-generated by SEIF)
    worksheet.columns = [
...
const generatePrefilledEmploymentTemplate = async (students = [], partnerName = 'Partner') => {
  try {
    ...
    const instructions = [
      ...
      '   Employed | Self-Employed | Entrepreneur | Unemployed | Further Education',
      '',
