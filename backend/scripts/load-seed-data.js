      ...
      try {
        ...
        if (statement.includes('refurbishment_packages')) {
          ...
          if (packageCount <= 5) console.log(`  ✅ Inserted electrical package ${packageCount}`);
            ...
            console.log(`  ✅ Inserted solar package ${packageCount - 5}`);
          else if (packageCount <= 15)
            console.log(`  ✅ Inserted automation package ${packageCount - 10}`);
          else if (packageCount <= 20)
            console.log(`  ✅ Inserted furniture package ${packageCount - 15}`);
