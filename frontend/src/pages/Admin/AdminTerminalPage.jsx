    ...
    try {
      ...
      setDiagnostics({
        deployment: {
          ...
          version: "Error: " + (error.response?.status || error.message),
        },
        database: {
          connected: false,
          message:
            "Unable to test connection: " + (error.message || "Unknown error"),
        },
        api: {
          healthy: false,
    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-6">
          ...
          <p className="text-gray-600">
            Comprehensive system monitoring, deployment tracking, and error
            analysis
          </p>
        </div>
                ...
                {diagnostics.files && (
                  <div className="border-l-4 border-purple-500 pl-4 py-2">
                    ...
                    <div className="text-sm space-y-2">
                      {Object.entries(diagnostics.files).map(
                        ([fileName, hash]) => (
                          <div
                            key={fileName}
                  ...
                  <div className="border-l-4 border-green-500 pl-4 py-2">
                    ...
                    <div className="text-sm space-y-1">
                      <p className="text-gray-700">
                        ...
                        {diagnostics.pm2.name || "N/A"}
                      </p>
                      <p className="text-gray-700">
                        <span className="font-medium">Status:</span>{" "}
                        <span
                          className={
                            diagnostics.pm2.status === "online"
                              ? "text-green-600"
                              : "text-red-600"
                          }
                        >
                      ...
                      <p className="text-gray-700">
                        ...
                        {diagnostics.pm2.uptime || "N/A"}
                      </p>
                      <p className="text-gray-700">
                        <span className="font-medium">Restarts:</span>{" "}
                        {diagnostics.pm2.restarts || 0}
                      </p>
                      <p className="text-gray-700">
                        <span className="font-medium">Memory:</span>{" "}
                        {diagnostics.pm2.memory || "N/A"}
                      </p>
                    </div>
                  </div>
                )}
                      ...
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-sm text-gray-600 mt-1">
                            ...
                            {error.count > 1 ? "s" : ""} in the last {lines} log
                            lines
                          </p>
                        </div>
                        <div
            ...
            <div className="bg-blue-50 border-2 border-blue-200 rounded-lg p-6">
              ...
              <div className="space-y-3 text-sm">
                ...
                <div className="bg-white p-3 rounded">
                  ...
                  <p className="text-gray-700 mt-1">
                    → Check SQL syntax and database schema migrations
                  </p>
                </div>
                <div className="bg-white p-3 rounded">
                  <p className="font-semibold text-gray-900">
                  ...
                  <p className="text-gray-700 mt-1">
                    → Check for undefined variables or incorrect data types
                  </p>
                </div>
                <div className="bg-white p-3 rounded">
                  <p className="font-semibold text-gray-900">
                    Request Timeouts (ETIMEDOUT)
                  </p>
                  <p className="text-gray-700 mt-1">
                    → Check network connectivity and increase timeout limits
                  </p>
                </div>
              </div>
            </div>
        ...
        {selectedView === "logs" && (
          <div className="space-y-6">
            ...
            <div className="mt-4 text-center text-sm text-gray-500">
              ...
              <p className="mt-1">
                ⚠️ This dashboard shows real-time application diagnostics, logs,
                and error analysis.
              </p>
              <p className="mt-1">
