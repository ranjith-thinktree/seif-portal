  ...
  return (
    <div className="space-y-4">
      <AdvancedSearchBar
        ...
        filterGroups={[
          ...
          },
          {
            ...
            options: [
              ...
              { value: "over30days", label: "Over 30 days" },
            ],
            multi: false,
          },
        ]}
        ...
        storageKey="refurbishment-eligible-centers"
      />
          ...
          <TableBody>
            {!centers || centers.length === 0 ? (
              <TableRow>
                ...
                >
                  <p className="text-lg">No eligible centers at this time</p>
                </TableCell>
              </TableRow>
            ) : (
...
export default EligibleCentersTable;
